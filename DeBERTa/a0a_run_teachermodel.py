...
def create_model(args, num_labels, model_class_fn):
  ...
  model = TeacherModel.load_model( "deberta-v3-large", args.model_config, num_labels=num_labels, \
      drop_out=args.cls_drop_out,cluster_path=args.cluster_path, only_return_hidden=args.only_return_hidden )
...
def build_argument_parser():
  ...
  parser.add_argument('--cluster_path',
            default=None,
            type=str,
            help="Sense Dict Path")
  parser.add_argument('--teacher_ckpt_path',
            default=None,
            type=str,
            help="Teacher Ckpt Path.")
  parser.add_argument('--only_return_hidden',
            default=False,
            type=bool,
            help="Teacher Ckpt Path.")
