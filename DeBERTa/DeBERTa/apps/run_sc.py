...
from DeBERTa.apps.t.sc_model import  SCModel
...
def create_model(args, num_labels, model_class_fn):
  ...
  model = SCModel.load_model(init_model, args.model_config, num_labels=num_labels, \
      drop_out=args.cls_drop_out, \
      pre_trained = args.pre_trained)
  print("Load ckpt")
  # Path to your .bin file
  bin_file_path = './tmp/ttonly/deberta-v3-large/MNLI_v2/pytorch.model-018407.bin'
